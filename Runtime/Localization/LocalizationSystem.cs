...
namespace MToolKit.Runtime.Localization
{
  public class LocalizationSystem : Singleton<LocalizationSystem> 
  {
    ...
    public Subject<string> Language = new Subject<string>();
    ...
    private bool LocalizationSettingsReady => LocalizationSettings.HasSettings && 
    ...
    private void InitializeLocalization()
    {
      try
      {
        ...
        else
        {
          ...
          _isInitialized = true; // Set to true to prevent infinite waiting
        }
    ...
    public void SetNewLocale(string languageCode)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    var fallbackLocale = LocalizationSettings.AvailableLocales.Locales[0];
