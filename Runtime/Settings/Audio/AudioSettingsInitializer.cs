...
namespace MToolKit.Runtime.Settings.Audio
{
  ...
  public class AudioSettingsInitializer : AbstractSettingsInitializer
  {
    ...
    [SerializeField, Required] private FloatBoundElementSlider masterVolumeSlider;
    [SerializeField, Required] private FloatBoundElementSlider musicVolumeSlider;
    [SerializeField, Required] private FloatBoundElementSlider gameVolumeSlider;
    [SerializeField, Required] private FloatBoundElementSlider interfaceVolumeSlider;
