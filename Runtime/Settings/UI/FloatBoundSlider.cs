...
namespace MToolKit.Runtime.Settings.UI
{
    ...
    private static ILogger log => logLazy.Value ?? Serilog.Core.Logger.None;
        ...
        private void OnSliderValueChanged(float newValue)
        {
            ...
            log.ForGameObject(gameObject).ForMethod(nameof(OnSliderValueChanged)).Information("Slider {name} value changed to {newValue}", FloatBoundReactiveSetting.Setting.Name, newValue);
        }
