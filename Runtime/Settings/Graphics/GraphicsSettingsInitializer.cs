...
namespace MToolKit.Runtime.Settings.Graphics
{
    public class GraphicsSettingsInitializer : AbstractSettingsInitializer
    {
        ...
        [SerializeField, Required] private IntBoundElementDropdown resolutionDropdown;
        [SerializeField, Required] private IntBoundElementDropdown qualityDropdown;
        [SerializeField, Required] private BoolBoundToggle fullscreenToggle;
        [SerializeField, Required] private BoolBoundToggle vsyncToggle;
