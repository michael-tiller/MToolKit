...
namespace MToolKit.Runtime.Persistence
{
    ...
    public class SaveSystemCoordinator : IRuntimeSystem
    {
        ...
        public SaveSystemCoordinator(IES3Service es3Service, SaveDomainControllerRegistry globalRegistry, SaveDomainControllerRegistry localRegistry, ES3SaveConfig saveConfig, IProfileManager profileManager)
        {
        ...
        public void Start()
        {
            ...
            var globalControllers = globalRegistry.GetControllers().ToList();
            ...
            var localControllers = localRegistry.GetControllers().ToList();
        ...
        {
            var activeSystem = useLocalSystem ? localSaveSystem : globalSaveSystem;
        ...
        public async UniTask SaveAsync(CancellationToken ct = default)
        {
            ...
            var activeRegistry = useLocalSystem ? localRegistry : globalRegistry;
            var controllers = activeRegistry.GetControllers().ToList();
