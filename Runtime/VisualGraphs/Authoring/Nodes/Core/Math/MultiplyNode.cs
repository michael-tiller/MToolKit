...
{
  /// <summary>
  ///   Multiplies two float state values and writes the product to a third state key.
  /// </summary>
  [CreateNodeMenu("Core/Math/Multiply")]
  [NodeTint("#8B5C5C")]
  [NodeWidth(300)]
  public sealed class MultiplyNode : VisualGraphNodeBase
  {
    ...
    [BoxGroup("Result")]
    [Required]
    [Tooltip("State key the product is written to")]
