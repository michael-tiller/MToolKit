...
using MToolKit.Runtime.VisualGraphs.Authoring.Nodes;
    ...
    public sealed class XNodeGraphExporter
    {
        ...
        private void Validate(NodeGraph graph)
        {
            ...
            foreach (var node in graph.nodes)
            {
                ...
                if (_nodeRegistry != null && !_nodeRegistry.HasExecutor(nodeTypeName))
                {
        ...
        /// </summary>
        private object NormalizeUnityObject(UnityEngine.Object obj)
        {
