...
namespace MToolKit.Runtime.Audio.Config
{
  ...
  public class AudioConfig : ScriptableObject
  {
    ...
    [SerializeField, Tooltip("Direct reference to AudioSource prefab (non-addressable fallback)")]
    private AudioSource audioSourcePrefab;
    
    [BoxGroup("Audio Source Prefab")]
    [SerializeField, Tooltip("Addressable reference to AudioSource prefab (drag from Addressables window)")]
    private AssetReference audioSourcePrefabReference;

    [BoxGroup("Audio Mixer")]
    [SerializeField, Required, ValidateInput("@masterMixerGroup != null", "Master Mixer Group is required")]
    private AudioMixerGroup masterMixerGroup;
    
    [BoxGroup("Audio Mixer")]
    [SerializeField, Required, ValidateInput("@musicMixerGroup != null", "Music Mixer Group is required")]
    private AudioMixerGroup musicMixerGroup;
    
    [BoxGroup("Audio Mixer")]
    [SerializeField, Required, ValidateInput("@gameMixerGroup != null", "Game Mixer Group is required")]
    private AudioMixerGroup gameMixerGroup;
    
    [BoxGroup("Audio Mixer")]
    [SerializeField, Required, ValidateInput("@interfaceMixerGroup != null", "Interface Mixer Group is required")]
    ...
    [BoxGroup("Audio Source Pool")]
    [SerializeField, MinValue(1), MaxValue(100)]
