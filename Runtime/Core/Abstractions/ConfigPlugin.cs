...
namespace MToolKit.Runtime.Core.Abstractions
{
    ...
    public abstract class ConfigPlugin<TService, TInterface, TConfig> : DomainPlugin<TService, TInterface>, IDependencyDeclaration
    ...
    public override IEnumerable<Type> OptionalServices => Array.Empty<Type>();
        ...
        public override void Register(IContainerBuilder builder)
        {
            ...
            if (config == null)
            {
                log.ForGameObject(gameObject).ForMethod(nameof(Register)).Error(
