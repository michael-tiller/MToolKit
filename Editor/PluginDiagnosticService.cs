  ...
  public static class PluginDiagnosticService
  {
    ...
    private static object FindGlobalInstaller()
    {
      ...
      if (installerType != null)
      {
        ...
        if (instanceProperty != null)
        {
          ...
          if (installer != null)
          {
            log.Debug("Found GlobalInstaller via reflection");
            return installer;
          }
        }
      }
      ...
      var installerObjects = Object.FindObjectsByType(typeof(MonoBehaviour), FindObjectsSortMode.None)
        ...
        if (containerProperty != null)
        {
          ...
          if (container != null)
          {
            ...
            if (childContainersProperty != null)
            {
              ...
              if (childContainers is IEnumerable enumerable)
              {
    ...
    private static bool CheckServiceResolution(Type serviceType, object installer)
    {
      try
      {
        ...
        var serviceObjects = Object.FindObjectsByType(typeof(MonoBehaviour), FindObjectsSortMode.None)
    ...
    {
      // This would need to be tracked in the plugin implementation
      // For now, assume plugins are not in an initialization phase
      return false;
    }
    ...
    private static void GatherGlobalInstallerPluginsViaReflection(object installer, List<PluginStateModel> diagnostics)
    {
      try
      {
        ...
        {
          var allPlugins = Object.FindObjectsByType<AbstractGamePlugin>(FindObjectsSortMode.None);
